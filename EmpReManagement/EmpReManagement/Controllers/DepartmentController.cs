...
namespace EmpReManagement.Controllers
{
    public class DepartmentController : Controller
    {
        ...
        public async Task<IActionResult> DepartmentConsolidateReport()
        {
            ...
            // Map the data to the DepartmentViewModel
            //var result = departments.Select(d => new DepartmentViewModel
            //{
            //    Name = d.Name,
            //    Employees = d.Employees.Select(e => new EmployeeViewModel
            //    {
            ...
            return View(departments); // Pass the mapped view model to the view
        }
